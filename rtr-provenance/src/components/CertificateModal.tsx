  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <motion.div
        ...
        style={{ borderTop: '2px solid #7ec85a', maxWidth: 580 }}
      >
        {/* Close */}
        ...
        <div style={{
          border: '1.5px solid rgba(126,200,90,0.35)',
          borderRadius: 18,
          overflow: 'hidden',
          ...
          <div style={{
            ...
            borderBottom: '1px solid rgba(126,200,90,0.2)',
            padding: '24px 28px',
            ...
            <div style={{
              ...
              border: '1.5px solid rgba(126,200,90,0.4)',
              display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
            }}>
              <Award size={24} color="#7ec85a" strokeWidth={1.6} />
            </div>
            <div>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, letterSpacing: '0.3em', textTransform: 'uppercase', color: '#7ec85a', marginBottom: 4 }}>
                National Medicinal Plants Board · QCI
              </div>
              <div style={{ fontFamily: "'Instrument Sans', sans-serif", fontSize: 18, fontWeight: 700, color: '#e4ede0', lineHeight: 1.25 }}>
                NMPB–QCI VCSMPP
              </div>
              <div style={{ fontFamily: "'Instrument Sans', sans-serif", fontSize: 11, color: 'var(--night-dim)', marginTop: 2 }}>
            ...
            <div style={{
              ...
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 7, letterSpacing: '0.1em', marginTop: 1 }}>
                VERIFIED
              </div>
            </div>
          </div>
          ...
          <div style={{ padding: '24px 28px' }}>
            ...
            <div style={{ display: 'grid', gap: '0' }}>
              {[
                ...
                <div key={field.label} style={{
                  ...
                  <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--night-dim)', flexShrink: 0, paddingTop: 2 }}>
                    {field.label}
                  </span>
                  <span style={{
                    fontFamily: field.mono ? "'IBM Plex Mono', monospace" : "'Inter', sans-serif",
                    fontSize: field.mono ? 11 : 13,
                    color: field.value.includes('✓') ? '#7ec85a' : '#e4ede0',
                    textAlign: 'right',
                  }}>
                    {field.value}
                  </span>
            ...
            <div style={{
              ...
              background: 'rgba(126,200,90,0.06)',
              border: '1px solid rgba(126,200,90,0.16)',
              borderRadius: 12,
            }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                <Check size={13} color="#7ec85a" strokeWidth={3} style={{ flexShrink: 0, marginTop: 1 }} />
                <div style={{ fontFamily: "'Inter', sans-serif", fontSize: 12, color: 'var(--night-dim)', lineHeight: 1.55 }}>
            ...
            <div style={{
              ...
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9.5, color: 'rgba(200,146,46,0.7)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                Demo Data · Prototype Only
              </div>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: 'rgba(200,146,46,0.55)', marginTop: 3 }}>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9, color: 'var(--night-dim)', letterSpacing: '0.1em' }}>
                VERIFICATION ANCHORED TO
              </div>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: '#7ec85a', marginTop: 2 }}>
            ...
            <div style={{
              ...
              <Check size={11} color="#7ec85a" strokeWidth={3} />
              <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 9.5, color: '#9fda74', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
                Document Verified
              </span>
            </div>
          </div>
